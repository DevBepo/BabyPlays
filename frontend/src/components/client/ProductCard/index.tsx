...
export function ProductCard({
  ...
  return (
    ...
    >
      ...
      <div className="flex aspect-square w-full items-center justify-center bg-zinc-50 p-8">
        {imagemUrl ? (
          <img
            src={imagemUrl}
            alt={imagemAlt || nome}
      ...
      <div className="flex flex-1 flex-col border-t border-zinc-50 bg-white p-5">
