...
- Producao usa `docker-compose.vps.yml` na VPS Ubuntu.
...
- Variaveis sensiveis ficam nos arquivos protegidos da VPS, nunca no repositorio.
- Deploy e manual por SSH na branch `main`; nao existe CI/CD atualmente.
- Cloudflare fornece DNS/proxy e o Nginx usa o Origin Certificate instalado na VPS.
...
- Configurar variaveis de producao nos arquivos protegidos da VPS descritos em `docs/DEPLOY.md`.
